...
string output::makeFunctionType(const string& retType, const std::vector<string>& argTypes)
{
	stringstream res;
...
void output::printStructType(const string& name, const std::vector<string>& memTypes, const std::vector<string>& memNames)
{
...
void output::errorPrototypeMismatch(int lineno, const string& id, const std::vector<string>& argTypes) {
