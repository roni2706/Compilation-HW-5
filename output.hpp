...
namespace output{
    ...
    void printStructType(const string& name, const vector<string>& memTypes, const vector<string>& memNames);
    ...
    */
    ...
    void errorPrototypeMismatch(int lineno, const string& id, const vector<string>& argTypes);
